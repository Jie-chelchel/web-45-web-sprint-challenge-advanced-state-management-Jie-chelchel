...
2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
   Actions are like instructions. They tell the reducers what to do. Reducers will take the instruction and the current state and return teh new state and tell store how to do.
   Store holds all state, and will update states as instructed.
   Store is known as a 'single source of truth' because there is only one store to hold all states per app.
...
4. What is your favorite state management system you've learned and this sprint? Please explain why!
   Redux. It seems complicated at the beginning, but once you get it, it is very easy to use, and you feel everything is under control.
